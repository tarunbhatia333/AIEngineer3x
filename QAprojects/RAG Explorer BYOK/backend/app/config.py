...
# NOTE: This is the "bring your own key" variant of RAG Explorer. Groq/OpenAI/
# Pinecone API keys are never read from server config or env vars — they come
# from the request headers set by the frontend (from keys the visitor enters
# and stores only in their own browser). See backend/app/keys.py.
