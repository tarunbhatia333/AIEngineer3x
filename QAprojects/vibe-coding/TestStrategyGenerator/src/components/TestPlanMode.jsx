...
export default function TestPlanMode({ config, envStatus, onChangeMode }) {
  ...
  return (
    <section className="card">
      <div className="mode-header">
        ...
        <button className="link-btn" onClick={onChangeMode}>← Change mode</button>
      </div>

      {!ready && (
        <div className="warn">
          Missing credentials. Fill settings or the server <code>.env</code>.
        </div>
      )}
